...
<body class="bg-dark d-flex justify-content-center align-items-center vh-100 ">
    ...
    <div class="bg-white p-5 rounded-5 text-secondary " style="width: 25rem;">
        ...
        <form action="../funciones/user_insertar_sql.php" method="POST" name="registro" onsubmit="GuardarDatos();">
            <!--Código-->
    ...
    <script>
        ...
        // Función para borrar datos en localStorage
        function BorrarDatos() {
            ...
            localStorage.removeItem('anio_nac');
        }

        // Evento para detectar clic en el botón de enviar y borrar datos de localStorage
        document.addEventListener("submit", function(event) {
            if (event.target === document.forms.registro) {
                // Llama a la función para borrar datos antes de enviar el formulario
                BorrarDatos();
            }
        });
